...
You can play with it and observe code generation on [Compiler Explorer enum](https://godbolt.org/z/33ac3Khar) [Compiler Explorer class](https://godbolt.org/z/sferbdvjz)
